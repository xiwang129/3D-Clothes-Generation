...
data_root_part = "dataset/new_point_cloud/"
data_root_h5 = "dataset/new_point_cloud/"

parser = argparse.ArgumentParser()
parser.add_argument('--phase', type=str, default='train', help='train or test ?')
parser.add_argument('--workers', type=int, default=1, help='number of data loading workers')
parser.add_argument('--bs', type=int, default=4, help='input batch size [default: 30]')
...
parser.add_argument('--gan', default='gan', help='[gan,ls,wgan,hinge]')
...
parser.add_argument('--snapshot', type=int, default=10, help='how many epochs to save model')
parser.add_argument('--choice', default='tshirt', help='choice class')
...
parser.add_argument('--pretrain_model_G', default=True, help='use the pretrain model G')
parser.add_argument('--pretrain_model_D', default=False, help='use the pretrain model D')
parser.add_argument('--load_model_G', default=None, help='use the pretrain model G')
...
parser.add_argument('--epochs', type=int, default=100, help='Integer value for epochs.')
